...
public class Lease<T> {
    ...
    public static final int DEFAULT_DURATION_IN_SECS = 90;//TODO 多长时间不发心跳 认为宕机

    private T holder;//TODO 实例instance
    private long evictionTimestamp;//TODO 删除的时间戳
    private long registrationTimestamp;//TODO 注册的时间戳
    private long serviceUpTimestamp;//TODO 服务启动的时间戳
    // Make it volatile so that the expiration task would see this quicker
    private volatile long lastUpdateTimestamp;//TODO 上一次更新的时间戳
